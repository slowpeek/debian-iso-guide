...
desktop environments, one per iso. To say, =debian-live-12.8.0-amd64-gnome.iso=
evidently comes with the GNOME desktop, =debian-live-12.8.0-amd64-kde.iso= has
KDE Plasma and so on. An exception is =debian-live-12.8.0-amd64-standard.iso=
